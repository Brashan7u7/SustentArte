...
export class ApiService {
  ...
  editarProducto(product: ProductosUpInterface, id: number) {
    console.log(product)
    return this._http.put<ProductosUpInterface>(`http://localhost:3000/productos/${id}`, product, { headers: { 'Access-Control-Allow-Origin': '*' } });
  }
